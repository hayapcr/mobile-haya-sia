...
import com.example.hayaapps.Home.pertemuan_10.TenthTabsAdapter
import com.example.hayaapps.R
import com.example.hayaapps.databinding.ActivityTenthBinding
import com.example.hayaapps.databinding.ActivityThirteenthBinding
...
class ThirteenthActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tabsAdapter = ThirteenthAdapterClass(this)
        ...
        TabLayoutMediator(binding.tabLayout, binding.viewPager) { tab, position ->
            ...
            when (position) {
                ...
                1 -> {
                    ...
                    //Tambah Icon
                    tab.icon = ContextCompat.getDrawable(this, R.drawable.ic_dotted)
